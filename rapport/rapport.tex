...
% TODO expliquer démarche: nous avons utilisé deux méthodes pour trouver l'équation différentielle du système:
% - conservation de l'Em
% - somme des moments des forces (à faire si suffisamment de temps)
...
% TODO insérer figure
% TODO mettre en forme (oui, encore)
...
% TODO si suffisamment de temps, et pour vérifier les résultats trouvés avec la conservation de l'énergie mécanique
...
\end{flalign*}
Le système possède donc au moins deux points d'équilibres (qui se répètent), $\theta^* = 0$ et $\theta^* = \pi$. % TODO reformuler?
...
% TODO insérer figures rapport_figportraitphasemu2 et rapport_figportraitphasemu4
